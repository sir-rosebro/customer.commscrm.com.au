    ...
    <div className={`sign_up ${loading?'overlay':false}`}>
      ...
      <div className="sign_up_box">
        <div className="sign_up_image_wrapper">
          ...
          <img src="/img/sign_up.png" alt="people getting connceted via internet"/>
        </div>
        ...
        >
          ...
          <Checkbox checked={isAddressSame} onChange={() => setAddressSame(!isAddressSame)}>Billing address is same as shipping address.</Checkbox>
