      ...
      <Row gutter={[24, 0]}>
              ...
              <Card bordered={false} className="widget-2 h-full">
                <Statistic
                  title={
                    <>
                      <div className="icon">
                        <img src="/img/paypal-logo-2.png" alt="paypal" />
                      </div>
                      <h6>Paypal</h6>
        ...
        <Col span={24} md={8} className="mb-24">
          <Card
            ...
            title={[<h6 className="font-semibold m-0" key="1">Invoices</h6>]}
            extra={[
          ...
          >
            <List
              ...
              renderItem={(item) => (
                <List.Item
                  actions={[<Button type="link" key="1">{download} PDF</Button>]}
                >
                  <List.Item.Meta
                    title={item.title}
      ...
      <Row gutter={[24, 0]}>
        <Col span={24} md={16} className="mb-24">
          <Card
            ...
            bordered={false}
            title={[<h6 className="font-semibold m-0" key="1">Billing Information</h6>]}
